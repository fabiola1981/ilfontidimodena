<?php get_header(); ?>
    ...
    <section class="caviar-hero-area" id="home">
        ...
        <div class="caviar-hero-slides owl-carousel">
            <!-- Single Slides -->
            <div class="single-hero-slides bg-img" style="background-image: url(<?php bloginfo('template_url') ?>/assets/img/sitio/cena.jpeg);">
                ...
                <!-- Slider Nav -->
                <div class="hero-slides-nav bg-img" style="background-image: url(<?php bloginfo('template_url') ?>/assets/img/bg-img/hero-2.jpg);"></div>
            </div>
            <!-- Single Slides -->
            <div class="single-hero-slides bg-img" style="background-image: url(<?php bloginfo('template_url') ?>/assets/img/bg-img/hero-2.jpg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-11 col-md-6 col-lg-4">
                            <div class="hero-content">
                ...
                <!-- Slider Nav -->
                <div class="hero-slides-nav bg-img" style="background-image: url(<?php bloginfo('template_url') ?>/assets/img/bg-img/hero-1.jpg);"></div>
            </div>
        </div>
    </section>
    <!-- ****** Welcome Area End ****** -->
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="about-us-thumbnail wow fadeInUp" data-wow-delay="0.5s">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/sitio/cena.jpeg" alt="">
                    </div>
                </div>
            ...
            <div class="about-us-second-part">
                <div class="row align-items-center pt-200">
                    ...
                    <div class="col-12 col-md-6 ml-md-auto">
                        <div class="about-us-thumbnail wow fadeInUp" data-wow-delay="0.5s">
                            <img src="<?php bloginfo('template_url') ?>/assets/img/sitio/mesas.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="caviar-single-dish wow fadeInUp" data-wow-delay="0.5s">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/menu-img/dish-1.png" alt="">
                        <div class="dish-info">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="caviar-single-dish wow fadeInUp" data-wow-delay="1s">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/menu-img/dish-2.png" alt="">
                        <div class="dish-info">
                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="caviar-single-dish wow fadeInUp" data-wow-delay="1.5s">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/menu-img/dish-3.png" alt="">
                        <div class="dish-info">
                            <h6 class="dish-name">Lorem Ipsum Dolor Sit Amet</h6>
                            <p class="dish-price">$45</p>
                        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-9 ml-md-auto">
                    <div class="caviar-awards d-sm-flex justify-content-between">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/awards-img/a-1.png" alt="">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/awards-img/a-2.png" alt="">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/awards-img/a-3.png" alt="">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/awards-img/a-4.png" alt="">
                        <img src="<?php bloginfo('template_url') ?>/assets/img/awards-img/a-5.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="caviar-reservation-area d-md-flex align-items-center" id="reservation">
        ...
        <div class="reservation-side-thumb wow fadeInRightBig" data-wow-delay="0.5s">
            <img src="<?php bloginfo('template_url') ?>/assets/img/bg-img/hero-3.jpg" alt="">
        </div>
    </section>
